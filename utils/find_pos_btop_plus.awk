...
#
# Note: This script only works for BLAST hits on the PLUS STRAND of the reference genome!
#
# usage: gawk -v query_ind=<int> -v query_start=<int> -v ref_start=<int> -f find_pos_btop_plus.awk <<< <BTOP string>
